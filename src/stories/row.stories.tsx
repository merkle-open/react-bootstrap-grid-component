...
stories['addWithJSX'](
    ...
    <BackgroundHelper>
        <Container>
            ...
            <Row 
                verticalAlignment={{xs: "center",sm: "center", md: "start", lg: "end"}}>
                <Column 
                    size={{xs: 5, sm: 5, md: 8}}
                >
                    <p>Text example</p>
...
stories['addWithJSX'](
    ...
    <BackgroundHelper>
        <Container>
            <Row><p>Horizontally aligned items inside row</p></Row>
            <Row 
                horizontalAlignment={{xs: "start", sm: "start", md: "between"}}>
                <Column size={8}>
                    <p>xs: start</p>
                    <p>sm: start</p>
                    <p>md: between</p>
            ...
            <Row
                horizontalAlignment={{xs: "center", sm: "center", md: "end"}}
            >
                <Column size={8}>
                    <p>xs: center</p>
                    <p>sm: center</p>
...
stories['addWithJSX'](
    "Nested Rows - Horizontal Alignment Behavior", 
    () => 
    <BackgroundHelper>
        <Container>
            <div>
            ...
            <Row horizontalAlignment={"center"}>
                ...
                <Column size={5}>
                    <Row horizontalAlignment={"start"}>
                        <Column size={8}>
                            <Row horizontalAlignment={"center"}>
                                <Column size={8}><p>center -> start -> center</p></Column>
                            </Row>
                        </Column>
                    </Row>
                </Column>
...
stories['addWithJSX'](
    "Nested Rows - Verticalal Alignment Behavior", 
    () => 
    <div className="Row-verticalAlignment">
    <BackgroundHelper>
        <Container>
            ...
            <Row verticalAlignment={"start"}>
                <Column size={12}>
                    <Row verticalAlignment={"center"}>
                        ...
                        <Column size={3}>
                            <Row verticalAlignment={"start"}>
                                <Column size={12}><p>start -> center -> start</p></Column>
                            </Row>
                        </Column>
                    </Row>
                </Column>
            ...
            <Row horizontalAlignment={"center"}>
                <Column size={6}>
                    <Row verticalAlignment={"center"}>
                        <Column size={12}><p>center -> center</p></Column>
                    </Row>
                </Column>
                <Column size={6}>
                    <Row verticalAlignment={"end"}>
                    <Column size={12}><p>center -> end</p></Column>
                    </Row>
                </Column>
            </Row>
        </Container>
