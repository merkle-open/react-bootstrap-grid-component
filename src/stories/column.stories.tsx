    ...
    <BackgroundHelper>
        <Container>
            ...
            <Row>
                <Column 
                    size={{xs: 5, sm: 5, md: 8}}
                    verticalAlignment={{xs: 'top', sm: 'top', md: 'bottom'}}
                >
                    <p>Text example</p>
                </Column>
                <Column 
...
stories['addWithJSX'](
    ...
    <BackgroundHelper>
        <Container>
            <Row><p>Horizontally aligned items inside column</p></Row>
            <Row>
                <Column 
                    direction={'row'}
                    size={{xs: 6, sm: 6, md: 4}}
...
stories['addWithJSX'](
    ...
    <BackgroundHelper>
        <Container>
            <Row><p>Direction of the items inside the column</p></Row>
            <Row>
                <Column 
                    direction={'col'}
                    size={{xs: 8, sm: 4, md: 4}}
...
stories['addWithJSX'](
    "Nested Columns - Vertical Alignment Behvior",
    () => 
    <div className="Col-verticalAlignment">
        <BackgroundHelper>
            <Container>
...
stories['addWithJSX'](
    "Nested Columns - Horizontal Alignment Behvior",
    () => 
    <div className="Col-verticalAlignment">
        <BackgroundHelper>
            <Container>
